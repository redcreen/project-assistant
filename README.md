...
```bash
curl -fsSL https://raw.githubusercontent.com/redcreen/project-assistant/v0.1.7/install.sh | bash
```
...
```bash
git clone --branch v0.1.7 https://github.com/redcreen/project-assistant.git ~/.codex/skills/project-assistant
```
...
```bash
PROJECT_ASSISTANT_REF=v0.1.7 PROJECT_ASSISTANT_DIR="$HOME/.codex/skills/project-assistant" bash install.sh
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/redcreen/project-assistant/v0.1.7/install-vscode-tools.sh | bash
```
...
- if you only want one extension, run `curl -fsSL https://raw.githubusercontent.com/redcreen/project-assistant/v0.1.7/install-vscode-tools.sh | PROJECT_ASSISTANT_VSCODE_COMPONENTS=project-assistant-host bash` or replace it with `workspace-doc-browser`
