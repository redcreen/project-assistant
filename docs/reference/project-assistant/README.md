# project-assistant Reference Pack
...
- [host-resume-bridge.md](host-resume-bridge.md): explains the missing host-side resume bridge above the daemon and evaluates VS Code extension feasibility as the first host
