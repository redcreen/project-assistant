...
```bash
curl -fsSL https://raw.githubusercontent.com/redcreen/project-assistant/v0.1.7/install-vscode-tools.sh | PROJECT_ASSISTANT_VSCODE_COMPONENTS=project-assistant-host bash
```
